...
const tab = useActivityBarStore.getState().tabs.find((entry) => entry.id === TAB_ID);
...
const relabeled = useActivityBarStore.getState().tabs.find((entry) => entry.id === TAB_ID);
